...
import static edu.fudan.conf.DefaultConf.activeScript;
import static edu.fudan.conf.DefaultConf.env;
import static edu.fudan.conf.DefaultConf.myScriptDir;
import static edu.fudan.conf.DefaultConf.predictScript;
import static edu.fudan.conf.DefaultConf.trainScript;
